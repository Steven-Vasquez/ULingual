    ...
    return( 
        <div className="forum-container">
            ...
            <div className="inner-post">
                ...
                <input type="text" className="post-input-for" placeholder="Something to say?!..." style={{ width: '8000000000000000000000000%', height: '25px', fontSize: '10px' }} />
            ...
            <div className="forum-return">
                <Link to="/globalforum" className="return-button">
